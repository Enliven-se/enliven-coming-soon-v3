...
exports.default = function ($, isSupportViewportUnits) {
    var fixedTopTimeout,
        scrollTimeout,
        prevScrollTop = 0,
        fixedTop = null,
    ...
    if (isMobile && navigator.userAgent.match(/Chrome/i)) {
        ...
        // fallback for .section-full-height
        $(window).smartResize(function () {
            $('.section-full-height').css('height', $(window).height() + 'px');
        });
        if ($('html').hasClass('site-loaded') && $('.section-full-height').length) $(window).resize();
    }
    ...
    if (enabled.length) {
        ...
        $('[data-16by9]').css('height', '').removeAttr('data-16by9');
    }

    // .parallax-background
    if ($.fn.jarallax && !isMobile) {
        $(document).on('destroy.parallax', function (event) {
            $('.parallax-background').jarallax('destroy').css('position', '');
        });
        $('.parallax-background').jarallax().css('position', 'relative');
    }
...
exports.default = function ($) {
  ...
  $('#insightly_web_to_lead').submit(function (event) {
    ...
    if ($('.form-check-input:checked').size() === 0) {
      $('.form-check').append('<div class="form-error alert alert-danger" role="alert">Please tick at least one of the checkboxes.</div>');
      return false;
    }
    return true;
  });
...
},{"marquee3000":6}],5:[function(require,module,exports){
'use strict';
...
var _ready = require('./_ready');

var _ready2 = _interopRequireDefault(_ready);

var _isSupportViewportUnits = require('./_isSupportViewportUnits');

var _isSupportViewportUnits2 = _interopRequireDefault(_isSupportViewportUnits);

var _mobirise = require('./_mobirise');

var _mobirise2 = _interopRequireDefault(_mobirise);
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    // scrollbarWidth();
    (0, _mobirise2.default)($, _isSupportViewportUnits2.default);
    (0, _ready2.default)($);
  });
})(jQuery);
...
},{"./_init":1,"./_isSupportViewportUnits":2,"./_mobirise":3,"./_ready":4}],6:[function(require,module,exports){
/**
